...
// src/app.ts
var import_express4 = __toESM(require("../node_modules/express/index.js"));
var import_helmet = __toESM(require("../node_modules/helmet/index.mjs"));
...
var envVarsSchema = import_joi.default.object().keys({
  ...
  EMAIL_FROM: import_joi.default.string().description(
...
var logger = import_winston.default.createLogger({
  ...
  format: import_winston.default.format.combine(
    ...
    env.env === "development" ? import_winston.default.format.colorize() : import_winston.default.format.uncolorize(),
    import_winston.default.format.splat(),
    import_winston.default.format.printf(({ level, message }) => `${level}: ${message}`)
  ),
  transports: [
...
var import_express_rate_limit = __toESM(require("../node_modules/express-rate-limit/dist/index.mjs"));
...
// src/routes/v1/city.ts
var cityRoute = import_express.default.Router();
cityRoute.get(
  "/search",
...
var tripRoute = import_express2.default.Router();
tripRoute.get(
  "/search",
  validate(tripValidation.getMany),
  tripController.getMany
);
